...
procedure InitAX2BXC;
var
	Form:TSGForm = nil;
begin
Form:=TSGForm.Create;
SGScreen.CreateChild(Form);
Form.SetMiddleBounds(300,300);
Form.Caption:='';

Form.CreateChild(TSGEdit.Create);
Form.LastChild.Caption:='';
Form.LastChild.SetBounds(10,10,100,30);
...
IsMand:=False;
{
readLn(MandaDepth,Byte(IsMand),QuantityThreads);
}
end;
