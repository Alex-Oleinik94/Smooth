...
{$IFNDEF MOBILE}
	...
	program Main;
{$ELSE}
	// Äåëî â òîì, ÷òî íà àíäðîèäå íàøå ïðèëîæåíèå çàãðóæàåòñÿ êàê áèáëèîòåêà ê ïðèëîæåíèþ, íàïèñàííîìó íà Java
	library Main;
	{$ENDIF}
uses
	{$IFDEF UNIX}
...
with TSGDrawClasses.Create(MyContext) do
	...
	Add(TSGFractalKohTriangle);//Òðåóãîëüíèê Ñåðïèíñêîãî
...
{$IFNDEF ANDROID}
	...
	program Main;
{$ELSE}
	// Æ’Ã‚ÃŽÃ“ â€š ÃšÃ“Ã, ËœÃšÃ“ ÃŒâ€¡ â€¡ÃŒâ€°ï£¿Ã“Ã‹â€°Ã‚ ÃŒâ€¡Â¯Ã‚ Ã”ï£¿Ã‹ÃŽÃ“ÃŠÃ‚ÃŒÃ‹Ã‚ Ãâ€¡â€žï£¿Ã›ÃŠâ€¡Ã‚ÃšÃ’Ë‡ Ãâ€¡Ã Â·Ã‹Â·ÃŽÃ‹Ã“ÃšÃ‚Ãâ€¡ Ã Ã”ï£¿Ã‹ÃŽÃ“ÃŠÃ‚ÃŒÃ‹Ë›, ÃŒâ€¡Ã”Ã‹Ã’â€¡ÃŒÃŒÃ“ÃÃ› ÃŒâ€¡ Java
	library Main;
	{$ENDIF}
uses
	{$IFDEF UNIX}
...
with TSGDrawClasses.Create(MyContext) do
	...
	Add(TSGFractalMengerSpunchRelease);
	Add(TSGFractalMandelbrodRelease);
	Add(TSGFractalKohTriangle);//â€œï£¿Ã‚Ã›â€žÃ“ÃŽÂ¸ÃŒÃ‹Ã â€”Ã‚ï£¿Ã”Ã‹ÃŒÃ’ÃÃ“â€žÃ“
	Add(TSGFractalTetraider);
	Add(TSGFractalLomanaya);
	Add(TSGFractalPodkova);
	Add(TSGGraphViewer);
