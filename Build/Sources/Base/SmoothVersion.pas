...
Stream := TMemoryStream.Create();
SWriteStringToStream(s1 + SWinEoln, Stream, False);
SWriteStringToStream(s2 + SWinEoln, Stream, False);
SWriteStringToStream(s3 + SWinEoln, Stream, False);
SWriteStringToStream(s4 + SWinEoln, Stream, False);
SWriteStringToStream(Iff(IsRelease, 'Release', 'Debug') + SWinEoln, Stream, False);
d.Get();
SWriteStringToStream(SStr(d.Years) + '/' + SStr(d.Month) + '/' + SStr(d.Day) + SWinEoln, Stream, False);
Stream.Position := 0;
