...
procedure LoadBMP(Stream : TStream; BitMap : TSBitMap);
procedure SaveBMP(BitMap : TSBitMap; Stream : TStream);
 ...
 try
  ...
  begin
   ...
   case biBitCount of
    ...
    else SLog.Source('LoadBMP : Wrong bitmap : biBitCount doesn''t match any allowed value');
   end;
   ...
   if biCompression <> BI_RGB then
	begin
    SLog.Source('LoadBMP : TODO : RLE compressed and bitfields bitmaps not implemented yet');
    Exit;
    end;
