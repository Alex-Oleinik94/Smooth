...
InternetConsoleCaller.AddComand(@SGConsoleConnectionsCaptor, ['cc'], 'Connections captor');
end;
...
BuildConsoleCaller.AddComand(@SGConsoleClearFileForRegistrationExtensions, ['Cffre'], 'Clear File For Registration Extensions');
