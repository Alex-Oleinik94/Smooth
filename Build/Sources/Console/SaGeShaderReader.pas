...
type
	...
	TSGShaderReader = class(TSGNamed)
			public
...
function SGReadShaderSourceFromFile(const VFileName : TSGString; const VFileParams : TSGStringList ):TSGString;{$IFDEF SUPPORTINLINE}inline;{$ENDIF}overload;
...
procedure SGReadAndSaveShaderSourceFile(const VInFileName, VOutFileName : TSGString; const VFileParams : TSGStringList );{$IFDEF SUPPORTINLINE}inline;{$ENDIF}overload;
...
procedure SGSaveShaderSourceToFile(const VFileName, VSource : TSGString);{$IFDEF SUPPORTINLINE}inline;{$ENDIF}
begin
SGExportStringToFile(VFileName, VSource);
end;
...
class function TSGShaderReader.ClassName() : TSGString;
begin
Result := 'TSGShaderReader';
end;
