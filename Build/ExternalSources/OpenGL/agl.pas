...
var
  ...
  aglNextPixelFormat : function(pix:TAGLPixelFormat):TAGLPixelFormat;cdecl;
  aglDescribePixelFormat : function(pix:TAGLPixelFormat; attrib:GLint; value:PGLint):GLboolean;cdecl;
  aglDevicesOfPixelFormat : function(pix:TAGLPixelFormat; ndevs:PGLint):PAGLDevice;cdecl;
  aglQueryRendererInfo : function(gdevs:PAGLDevice; ndev:GLint):TAGLRendererInfo;cdecl;
  aglDestroyRendererInfo : procedure(rend:TAGLRendererInfo);cdecl;
  aglNextRendererInfo : function(rend:TAGLRendererInfo):TAGLRendererInfo;cdecl;
  aglDescribeRenderer : function(rend:TAGLRendererInfo; prop:GLint; value:PGLint):GLboolean;cdecl;
  ...
  aglCopyContext : function(src:TAGLContext; dst:TAGLContext; mask:GLuint):GLboolean;cdecl;
  aglUpdateContext : function(ctx:TAGLContext):GLboolean;cdecl;
  aglSetCurrentContext : function(ctx:TAGLContext):GLboolean;cdecl;
  aglGetCurrentContext : function:TAGLContext;cdecl;
  aglSetDrawable : function(ctx:TAGLContext; draw:TAGLDrawable):GLboolean;cdecl;
  aglSetOffScreen : function(ctx:TAGLContext; width:GLsizei; height:GLsizei; rowbytes:GLsizei; baseaddr:PGLvoid):GLboolean;cdecl;
  ...
  aglSetVirtualScreen : function(ctx:TAGLContext; screen:GLint):GLboolean;cdecl;
  aglGetVirtualScreen : function(ctx:TAGLContext):GLint;cdecl;
  aglGetVersion : procedure(major:PGLint; minor:PGLint);cdecl;
  aglConfigure : function(pname:GLenum; param:GLuint):GLboolean;cdecl;
  aglSwapBuffers : procedure(ctx:TAGLContext);cdecl;
  aglEnable : function(ctx:TAGLContext; pname:GLenum):GLboolean;cdecl;
  aglDisable : function(ctx:TAGLContext; pname:GLenum):GLboolean;cdecl;
  aglIsEnabled : function(ctx:TAGLContext; pname:GLenum):GLboolean;cdecl;
  aglSetInteger : function(ctx:TAGLContext; pname:GLenum; params:PGLint):GLboolean;cdecl;
  aglGetInteger : function(ctx:TAGLContext; pname:GLenum; params:PGLint):GLboolean;cdecl;
  aglUseFont : function(ctx:TAGLContext; fontID:GLint; face:_AGLStyle; size:GLint; first:GLint; count:GLint; base:GLint):GLboolean;cdecl;
  aglGetError : function:GLenum;cdecl;
  aglErrorString : function(code:GLenum):PGLubyte;cdecl;
  aglResetLibrary : procedure;cdecl;
  aglSurfaceTexture : procedure(context:TAGLContext; target:GLenum; internalformat:GLenum; surfacecontext:TAGLContext);cdecl;
  ...
  aglDescribePBuffer : function(pbuffer:TAGLPbuffer; width:PGLint; height:PGLint; target:PGLenum; internalFormat:PGLenum; max_level:PGLint):GLboolean;cdecl;
  aglTexImagePBuffer : function(ctx:TAGLContext; pbuffer:TAGLPbuffer; source:GLint):GLboolean;cdecl;
  aglSetPBuffer : function(ctx:TAGLContext; pbuffer:TAGLPbuffer; face:GLint; level:GLint; screen:GLint):GLboolean;cdecl;
  aglGetPBuffer : function(ctx:TAGLContext; pbuffer:PAGLPbuffer; face:PGLint; level:PGLint; screen:PGLint):GLboolean;cdecl;
  aglGetCGLContext : function(ctx:TAGLContext; cgl_ctx:Ppointer):GLboolean;cdecl;
  aglGetCGLPixelFormat : function(pix:TAGLPixelFormat; cgl_pix:Ppointer):GLboolean;cdecl;
...
function InitAGL : Boolean;
begin
  lagl := dlopen( libagl, $001 );
  if lagl <> nil Then
    begin
      aglChoosePixelFormat    := dlsym( lagl, 'aglChoosePixelFormat' );
      aglDestroyPixelFormat   := dlsym( lagl, 'aglDestroyPixelFormat' );
      aglNextPixelFormat      := dlsym( lagl, 'aglNextPixelFormat' );
      aglDescribePixelFormat  := dlsym( lagl, 'aglDescribePixelFormat' );
      aglDevicesOfPixelFormat := dlsym( lagl, 'aglDevicesOfPixelFormat' );
      aglQueryRendererInfo    := dlsym( lagl, 'aglQueryRendererInfo' );
      aglDestroyRendererInfo  := dlsym( lagl, 'aglDestroyRendererInfo' );
      aglNextRendererInfo     := dlsym( lagl, 'aglNextRendererInfo' );
      aglDescribeRenderer     := dlsym( lagl, 'aglDescribeRenderer' );
      aglCreateContext        := dlsym( lagl, 'aglCreateContext' );
      aglDestroyContext       := dlsym( lagl, 'aglDestroyContext' );
      aglCopyContext          := dlsym( lagl, 'aglCopyContext' );
      aglUpdateContext        := dlsym( lagl, 'aglUpdateContext' );
      aglSetCurrentContext    := dlsym( lagl, 'aglSetCurrentContext' );
      aglGetCurrentContext    := dlsym( lagl, 'aglGetCurrentContext' );
      aglSetDrawable          := dlsym( lagl, 'aglSetDrawable' );
      aglSetOffScreen         := dlsym( lagl, 'aglSetOffScreen' );
      aglSetFullScreen        := dlsym( lagl, 'aglSetFullScreen' );
      aglGetDrawable          := dlsym( lagl, 'aglGetDrawable' );
      aglSetVirtualScreen     := dlsym( lagl, 'aglSetVirtualScreen' );
      aglGetVirtualScreen     := dlsym( lagl, 'aglGetVirtualScreen' );
      aglGetVersion           := dlsym( lagl, 'aglGetVersion' );
      aglConfigure            := dlsym( lagl, 'aglConfigure' );
      aglSwapBuffers          := dlsym( lagl, 'aglSwapBuffers' );
      aglEnable               := dlsym( lagl, 'aglEnable' );
      aglDisable              := dlsym( lagl, 'aglDisable' );
      aglIsEnabled            := dlsym( lagl, 'aglIsEnabled' );
      aglSetInteger           := dlsym( lagl, 'aglSetInteger' );
      aglGetInteger           := dlsym( lagl, 'aglGetInteger' );
      aglUseFont              := dlsym( lagl, 'aglUseFont' );
      aglGetError             := dlsym( lagl, 'aglGetError' );
      aglErrorString          := dlsym( lagl, 'aglErrorString' );
      aglResetLibrary         := dlsym( lagl, 'aglResetLibrary' );
      aglSurfaceTexture       := dlsym( lagl, 'aglSurfaceTexture' );
      aglCreatePBuffer        := dlsym( lagl, 'aglCreatePBuffer' );
      aglDestroyPBuffer       := dlsym( lagl, 'aglDestroyPBuffer' );
      aglDescribePBuffer      := dlsym( lagl, 'aglDescribePBuffer' );
      aglTexImagePBuffer      := dlsym( lagl, 'aglTexImagePBuffer' );
      aglSetPBuffer           := dlsym( lagl, 'aglSetPBuffer' );
      aglGetPBuffer           := dlsym( lagl, 'aglGetPBuffer' );
      aglGetCGLContext        := dlsym( lagl, 'aglGetCGLContext' );
      aglGetCGLPixelFormat    := dlsym( lagl, 'aglGetCGLPixelFormat' );
      Result := TRUE;
    end else
      Result := FALSE;
end;
