...
begin
    Result := {$ifndef fpc}GetPropertyName(uint32(index), Name, nameCount){$else} 0{$endif};
end;
...
begin
    Result := {$ifndef fpc}GetPropertyNameLength(uint32(index)){$else}0{$endif};
end;
...
begin
    {$ifndef fpc}Result := GetType(uint32(index));{$endif}
end;
...
begin
    Result := {$ifndef fpc}GetValueSize(uint32(index)){$else}0{$endif};
end;
...
begin
    Result := {$ifndef fpc}GetSubProperties(uint32(index), subProperties){$else}0{$endif};
end;
