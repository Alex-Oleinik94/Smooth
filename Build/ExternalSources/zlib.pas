...
*)
var zlibVersion : function: pchar ; cdecl ; 
...
*)
var deflateInit_ : function( var strm : z_stream ; level : cint ; version : pchar ; stream_size : cint ) : cint ; cdecl ; 
...
*)
var deflate : function( var strm : z_stream ; flush : cint ) : cint ; cdecl ; 
...
*)
var deflateEnd : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var inflateInit_ : function( var strm : z_stream ; version : pchar ; stream_size : cint ) : cint ; cdecl ; 
...
*)
var inflate : function( var strm : z_stream ; flush : cint ) : cint ; cdecl ; 
...
*)
var inflateEnd : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var deflateInit2_ : function( var strm : z_stream ; level , method , windowBits , memLevel , strategy : cint ; version : pchar ; stream_size : cint ) : cint ; cdecl ; 
...
*)
var deflateSetDictionary : function( var strm : z_stream ; dictionary : pbytef ; dictLength : uInt ) : cint ; cdecl ; 
...
*)
var deflateCopy : function( var dest , source : z_stream ) : cint ; cdecl ; 
...
*)
var deflateReset : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var deflateParams : function( var strm : z_stream ; level : cint ; strategy : cint ) : cint ; cdecl ; 
...
*)
var deflateTune : function( var strm : z_stream ; good_length , max_lazy , nice_length , max_chain : cint ) : cint ; cdecl ; 
...
*)
var deflateBound : function( var strm : z_stream ; sourceLen : uLong ) : uLong ; cdecl ; 
...
*)
var deflatePrime : function( var strm : z_stream ; bits , value : cint ) : cint ; cdecl ; 
...
*)
var deflateSetHeader : function( var strm : z_stream ; var head : gz_header ) : cint ; cdecl ; 
...
*)
var inflateInit2_ : function( var strm : z_stream ; windowBits : cint ; version : pchar ; stream_size : cint ) : cint ; cdecl ; 
...
*)
var inflateSetDictionary : function( var strm : z_stream ; dictionary : pbytef ; dictLength : uInt ) : cint ; cdecl ; 
...
*)
var inflateSync : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var inflateCopy : function( var dest , source : z_stream ) : cint ; cdecl ; 
...
*)
var inflateReset : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var inflatePrime : function( var strm : z_stream ; bits , value : cint ) : cint ; cdecl ; 
...
*)
var inflateGetHeader : function( var strm : z_stream ; var head : gz_header ) : cint ; cdecl ; 
...
*)
var inflateBackInit_ : function( var strm : z_stream ; windowBits : cint ; window : pointer ; version : pchar ; stream_size : cint ) : cint ; cdecl ; 
...
*)
var inflateBack : function( var strm : z_stream ; inf : in_func ; in_desc : pointer ; outf : out_func ; out_desc : pointer ) : cint ; cdecl ; 
...
*)
var inflateBackEnd : function( var strm : z_stream ) : cint ; cdecl ; 
...
*)
var compress : function( dest : pbytef ; destLen : puLongf ; source : pbytef ; sourceLen : uLong ) : cint ; cdecl ; 
...
*)
var compress2 : function( dest : pbytef ; destLen : puLongf ; source : pbytef ; sourceLen : uLong ; level : cint ) : cint ; cdecl ; 
...
*)
var compressBound : function( sourceLen : uLong ) : uLong ; cdecl ; 
...
*)
var uncompress : function( dest : pbytef ; destLen : puLongf ; source : pbytef ; sourceLen : uLong ) : cint ; cdecl ; 
...
*)
var gzopen : function( path : pchar ; mode : pchar ) : gzFile ; cdecl ; 
...
*)
var gzdopen : function( fd : cint ; mode : pchar ) : gzFile ; cdecl ; 
...
*)
var gzsetparams : function( thefile : gzFile ; level : cint ; strategy : cint ) : cint ; cdecl ; 
...
*)
var gzread : function( thefile : gzFile ; buf : pointer ; len : cardinal ) : cint ; cdecl ; 
...
*)
var gzwrite : function( thefile : gzFile ; buf : pointer ; len : cardinal ) : cint ; cdecl ; 
...
*)
var gzprintf : function( thefile : gzFile ; format : pbytef ; args : array of const ) : cint ; cdecl ; 
...
*)
var gzputs : function( thefile : gzFile ; s : pbytef ) : cint ; cdecl ; 
...
*)
var gzgets : function( thefile : gzFile ; buf : pbytef ; len : cint ) : pbytef ; cdecl ; 
...
*)
var gzputc : function( thefile : gzFile ; c : char ) : char ; cdecl ; 
...
*)
var gzgetc : function( thefile : gzFile ) : char ; cdecl ; 
...
*)
var gzflush : function( thefile : gzFile ; flush : cint ) : cint ; cdecl ; 
...
*)
var gzseek : function( thefile : gzFile ; offset : z_off_t ; whence : cint ) : z_off_t ; cdecl ; 
...
*)
var gzrewind : function( thefile : gzFile ) : cint ; cdecl ; 
...
*)
var gztell : function( thefile : gzFile ) : z_off_t ; cdecl ; 
...
*)
var gzeof : function( thefile : gzFile ) : longbool ; cdecl ; 
...
*)
var gzclose : function( thefile : gzFile ) : cint ; cdecl ; 
...
*)
var gzerror : function( thefile : gzFile ; var errnum : cint ) : pbytef ; cdecl ; 
...
*)
var gzclearerr : procedure( thefile : gzFile ) ; cdecl ; 
...
*)
var adler32 : function( adler : uLong ; buf : pbytef ; len : uInt ) : uLong ; cdecl ; 
...
*)
var adler32_combine : function( adler1 , adler2 : uLong ; len2 : z_off_t ) : uLong ; cdecl ; 
...
*)
var crc32 : function( crc : uLong ; buf : pbytef ; len : uInt ) : uLong ; cdecl ; 
...
*)
var crc32_combine : function( crc1 , crc2 : uLong ; len2 : z_off_t ) : uLong ; cdecl ; 
...
deflateBound := nil;
deflatePrime := nil;
deflateSetHeader := nil;
inflateInit2_ := nil;
inflateSetDictionary := nil;
inflateSync := nil;
inflateCopy := nil;
inflateReset := nil;
inflatePrime := nil;
inflateGetHeader := nil;
inflateBackInit_ := nil;
inflateBack := nil;
inflateBackEnd := nil;
compress := nil;
compress2 := nil;
...
begin
Result.Clear();
Result.FFunctionCount := 55;
LoadResult := @Result;
Pointer(zlibVersion) := LoadProcedure('zlibVersion');
Pointer(deflateInit_) := LoadProcedure('deflateInit_');
Pointer(deflate) := LoadProcedure('deflate');
Pointer(deflateEnd) := LoadProcedure('deflateEnd');
Pointer(inflateInit_) := LoadProcedure('inflateInit_');
Pointer(inflate) := LoadProcedure('inflate');
Pointer(inflateEnd) := LoadProcedure('inflateEnd');
Pointer(deflateInit2_) := LoadProcedure('deflateInit2_');
Pointer(deflateSetDictionary) := LoadProcedure('deflateSetDictionary');
Pointer(deflateCopy) := LoadProcedure('deflateCopy');
Pointer(deflateReset) := LoadProcedure('deflateReset');
Pointer(deflateParams) := LoadProcedure('deflateParams');
Pointer(deflateTune) := LoadProcedure('deflateTune');
Pointer(deflateBound) := LoadProcedure('deflateBound');
Pointer(deflatePrime) := LoadProcedure('deflatePrime');
Pointer(deflateSetHeader) := LoadProcedure('deflateSetHeader');
Pointer(inflateInit2_) := LoadProcedure('inflateInit2_');
Pointer(inflateSetDictionary) := LoadProcedure('inflateSetDictionary');
Pointer(inflateSync) := LoadProcedure('inflateSync');
Pointer(inflateCopy) := LoadProcedure('inflateCopy');
Pointer(inflateReset) := LoadProcedure('inflateReset');
Pointer(inflatePrime) := LoadProcedure('inflateReset');
Pointer(inflateGetHeader) := LoadProcedure('inflateGetHeader');
Pointer(inflateBackInit_) := LoadProcedure('inflateBackInit_');
Pointer(inflateBack) := LoadProcedure('inflateBack');
Pointer(inflateBackEnd) := LoadProcedure('inflateBackEnd');
Pointer(compress) := LoadProcedure('compress');
Pointer(compress2) := LoadProcedure('compress2');
Pointer(compressBound) := LoadProcedure('compressBound');
Pointer(uncompress) := LoadProcedure('uncompress');
Pointer(gzopen) := LoadProcedure('gzopen');
Pointer(gzdopen) := LoadProcedure('gzdopen');
Pointer(gzsetparams) := LoadProcedure('gzsetparams');
Pointer(gzread) := LoadProcedure('gzread');
Pointer(gzwrite) := LoadProcedure('gzwrite');
Pointer(gzprintf) := LoadProcedure('gzprintf');
Pointer(gzputs) := LoadProcedure('gzputs');
Pointer(gzgets) := LoadProcedure('gzgets');
Pointer(gzputc) := LoadProcedure('gzputc');
Pointer(gzgetc) := LoadProcedure('gzgetc');
Pointer(gzflush) := LoadProcedure('gzflush');
Pointer(gzseek) := LoadProcedure('gzseek');
Pointer(gzrewind) := LoadProcedure('gzrewind');
Pointer(gztell) := LoadProcedure('gztell');
Pointer(gzeof) := LoadProcedure('gzeof');
Pointer(gzclose) := LoadProcedure('gzclose');
Pointer(gzerror) := LoadProcedure('gzerror');
Pointer(gzclearerr) := LoadProcedure('gzclearerr');
Pointer(adler32) := LoadProcedure('adler32');
Pointer(adler32_combine) := LoadProcedure('adler32_combine');
Pointer(crc32) := LoadProcedure('crc32');
Pointer(crc32_combine) := LoadProcedure('crc32_combine');
Pointer(zError) := LoadProcedure('zError');
Pointer(inflateSyncPoint) := LoadProcedure('inflateSyncPoint');
Pointer(get_crc_table) := LoadProcedure('get_crc_table');
end;
