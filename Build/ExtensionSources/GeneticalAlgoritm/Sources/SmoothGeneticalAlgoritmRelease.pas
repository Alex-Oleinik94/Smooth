...
Screen.CreateInternalComponent(FNB);
Screen.LastInternalComponent.SetBounds(Render.Width-90,1 ,80,15);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
Screen.LastInternalComponent.Caption:='Заного';
...
FP1.CreateInternalComponent(FCBMM);
FP1.LastInternalComponent.SetBounds(QQQ+205,338 ,70,25);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Минимум');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Максимум');

FB1:=TSScreenButton.Create;
FP1.CreateInternalComponent(FB1);
FP1.LastInternalComponent.SetBounds(QQQ+150,338 ,50,25);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.Caption:='Найти';
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
...
FP1.CreateInternalComponent(FCB7);
FP1.LastInternalComponent.SetBounds(260,249,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
FP1.LastInternalComponent.Active:=False;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Микроэволюция');

FCB6:=TSScreenComboBox.Create;
FP1.CreateInternalComponent(FCB6);
FP1.LastInternalComponent.SetBounds(260,219,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
FP1.LastInternalComponent.Active:=False;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Элитный');

FCB5:=TSScreenComboBox.Create;
FP1.CreateInternalComponent(FCB5);
FP1.LastInternalComponent.SetBounds(260,189,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Простые');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Транстпозиция');

FCB4:=TSScreenComboBox.Create;
FP1.CreateInternalComponent(FCB4);
FP1.LastInternalComponent.SetBounds(260,159,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Стандартный двуточечьный');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Частично соответствующий одноточечный');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Упорядочивающий одноточечный');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Hа основе «Золотого сечения»');
...
FP1.CreateInternalComponent(FCB3);
FCB3.OnChange:=TSScreenComponentProcedure(@mmmFCB3OnChange);
FP1.LastInternalComponent.SetBounds(260,129,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Имбридинг');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Селекция по заданной шкале');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Аутбридинг');

FCB2:=TSScreenComboBox.Create;
FP1.CreateInternalComponent(FCB2);
FP1.LastInternalComponent.SetBounds(260,99,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Стратегия "Одеяла"');
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Стратегия "Дробовика"');

FCB1:=TSScreenComboBox.Create;
FP1.CreateInternalComponent(FCB1);
FP1.LastInternalComponent.SetBounds(260,69,270,21);
FP1.LastInternalComponent.Anchors:=[SAnchRight];
FP1.LastInternalComponent.FUserPointer1:=Self;
FP1.LastInternalComponent.Visible:=True;
FP1.LastInternalComponent.Active:=False;
(FP1.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
(FP1.LastInternalComponent as TSScreenComboBox).CreateItem('Бинарное');
