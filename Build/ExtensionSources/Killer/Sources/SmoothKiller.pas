...
Screen.CreateInternalComponent(FButtonReset);
Screen.LastInternalComponent.SetBounds(Render.Width-50,5,40,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
Screen.LastInternalComponent.Caption:='Reset';
...
Screen.CreateInternalComponent(FDifficultyComboBox);
Screen.LastInternalComponent.SetBounds(Render.Width-50-125-145,5,118+145,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Очень очень сильно легко');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Очень сильно легко');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Очень легко');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Легко');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Нормально');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Ну так, ничё');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Сложно');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Очень сложно');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Тяжко!');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Очень тяжко!!');
(Screen.LastInternalComponent as TSScreenComboBox).CallBackProcedure:=TSScreenComboBoxProcedure(@TSScreenComboBox_Difficulty_OnChange);
(Screen.LastInternalComponent as TSScreenComboBox).SelectItem:=4;
Screen.LastInternalComponent.FUserPointer1:=Self;
Screen.LastInternalComponent.Visible:=True;

FQuantityComboBox:=TSScreenComboBox.Create;
Screen.CreateInternalComponent(FQuantityComboBox);
Screen.LastInternalComponent.SetBounds(Render.Width-50-125-145-60,5,55,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
for i:=0 to 8 do
	(Screen.LastInternalComponent as TSScreenComboBox).CreateItem(SStringToPChar(SStr(2**i)));
(Screen.LastInternalComponent as TSScreenComboBox).CallBackProcedure:=TSScreenComboBoxProcedure(@TSScreenComboBox_DeepZombies_OnChange);
...
Screen.CreateInternalComponent(FComboBoxDeep);
Screen.LastInternalComponent.SetBounds(Render.Width-50-125-145-60-60,5,55,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
for i:=3 to 8 do
	(Screen.LastInternalComponent as TSScreenComboBox).CreateItem(SStringToPChar(SStr(2**i)));
(Screen.LastInternalComponent as TSScreenComboBox).CallBackProcedure:=TSScreenComboBoxProcedure(@TSScreenComboBox_CountZombies_OnChange);
(Screen.LastInternalComponent as TSScreenComboBox).SelectItem:=0;
Screen.LastInternalComponent.FUserPointer1:=Self;
Screen.LastInternalComponent.Visible:=True;

FComboBoxRespamn:=TSScreenComboBox.Create;
Screen.CreateInternalComponent(FComboBoxRespamn);
Screen.LastInternalComponent.SetBounds(Render.Width-50-125-145-60-60-130,5,125,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Респамн Выключен');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Респамн Включeн');
(Screen.LastInternalComponent as TSScreenComboBox).CallBackProcedure:=TSScreenComboBoxProcedure(@TSScreenComboBox_RespamnZombies_OnChange);
(Screen.LastInternalComponent as TSScreenComboBox).SelectItem:=1;
Screen.LastInternalComponent.FUserPointer1:=Self;
Screen.LastInternalComponent.Visible:=True;

FGroundComboBox:=TSScreenComboBox.Create;
Screen.CreateInternalComponent(FGroundComboBox);
Screen.LastInternalComponent.SetBounds(Render.Width-50-125-145-60-60-130-140,5,135,20);
Screen.LastInternalComponent.Anchors:=[SAnchRight];
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенок нету');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенок мало');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенок немного');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенок немало');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенок много');
(Screen.LastInternalComponent as TSScreenComboBox).CreateItem('Стенки везде');
(Screen.LastInternalComponent as TSScreenComboBox).CallBackProcedure:=TSScreenComboBoxProcedure(@TSScreenComboBox_GroundZombies_OnChange);
(Screen.LastInternalComponent as TSScreenComboBox).SelectItem:=2;
Screen.LastInternalComponent.FUserPointer1:=Self;
Screen.LastInternalComponent.Visible:=True;
